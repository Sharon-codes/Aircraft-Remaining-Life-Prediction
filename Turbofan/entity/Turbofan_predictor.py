...
class TurbofanData: 
    ...
    def get_Turbofan_data_as_dict(self): 
        """Returns data with descriptive labels for display purposes"""
        try : 
            input_data = {
    ...
    def get_input_data_for_model(self):
        """Returns data with original column names for model prediction"""
        try:
            input_data = {
    ...
    def get_Turbofan_data_dataframe(self): 
        """Returns DataFrame with original column names for model prediction"""
        try : 
            Turbofan_data = self.get_input_data_for_model()
